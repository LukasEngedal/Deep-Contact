...
from .grids import GridManager, particles_to_grids, InterpolationManager
...
for i in range(nParameters):
    ...
    for j in range(nWorlds):
        ...
        interp.create_interp(G, grid, attribute)
        ...
        for b in world.bodies:
            if b.type is b2_dynamicBody:
                value = interp.query_interp(attribute, b.position.x, b.position.y)
                worldTotal += value
